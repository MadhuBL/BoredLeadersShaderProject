...
public class WordCollisionTextAnimationView : MonoBehaviour
{
    ...
    public void AnimateIn()
    {
        ...
        tweenSeq.Join(DOVirtual.Float(0, 1, _fadeMsgMoveAnimDuration, v => {CommonVfxEffect.SetCustomMatPara(_leftMaterial, "_ShineLocation",v); } )).SetEase(Ease.Linear);
        tweenSeq.Insert(_fadeMsgMoveAnimDuration, DOVirtual.Float(0, 1, _fadeMsgMoveAnimDuration, v => {CommonVfxEffect.SetCustomMatPara(_rightMaterial, "_ShineLocation",v); } )).SetEase(Ease.Linear);
